...
export default function ButtonOverlay({isOpen, clickHandler}) {
    return (
        <div className='popupButton__container'>
            <div className="popupButton" onClick={clickHandler}>
                <div className={!isOpen?"icon activeIcon":"icon"}>
                    <img src="/wc_logo.png" />
